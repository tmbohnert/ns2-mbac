...
lappend eilastlevel 5	;# number of nodes for each cluster
...
######################################################
#$ns at 4.0 "$fire label-color red"
#$ns at 4.01 "$fire setdest 700.0 800.0 10000.0"

# traffic scenario
# scrar reports a fire
$ns at 5.0 "$cbr_sc start"
$ns at 5.2 "$ns trace-annotate \"SCAR detects and reports a fire\""
# ccenter communicates with the hcopter to lead the hcopter
#$ns at 6.0 "$cbr_cc start"
#$ns at 6.2 "$ns trace-annotate \"CCENTER communicates with the HCOPTER to coordinate the operation\""
# hcopter communicates with the ccenter to coordinate the fire fighters
#$ns at 7.0 "$cbr_hc start"
#$ns at 7.2 "$ns trace-annotate \"HCOPTER communicates with the CCENTER to report about the operation progress\""
...
#$ns at 8.0 "$hcopter setdest 800.0 700.0 50.0"
#$ns at 8.0 "$ns trace-annotate \"HCOPTER takes off towards the danger zone\""
# scar retreats to a safe place
$ns at 6.0 "$scar setdest 300.0 600.0 10.0"
$ns at 6.0 "$ns trace-annotate \"SCAR retreats from the danger zone\""
