...
#set tsm 5
#set wlen 20
#$dsQueue addAdcEntry $dscp0 SKDE ACCEPT $bnTxRate [expr $bufferSize*$packetSize] $txRate $pLoss TRDE $hRef $j IEDE TRDE $tau $tsm $wlen TRDE END
$dsQueue addAdcEntry $dscp0 SSUM $bnTxRate $txRate TRDE END
