...
set tsm 5
set wlen 300
$dsQueue addAdcEntry $dscp0 FHB ACCEPT $bnTxRate [expr $bufferSize*$packetSize] $txRate $pLoss TRE $t TRE $tau $tsm $wlen TRE FLOWMONE 1400 1510 [expr $simTime-5] END
