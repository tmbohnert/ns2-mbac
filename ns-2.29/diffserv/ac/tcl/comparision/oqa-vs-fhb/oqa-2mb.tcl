...
# window length
set wlen 300
$dsQueue addAdcEntry $dscp0 OQA ACCEPT $bnTxRate [expr $bufferSize*$packetSize] $txRate $pLoss TRE $rScore $frLenVoip $wlen TRDE FLOWMONE 1400 1510 [expr $simTime-5] END
