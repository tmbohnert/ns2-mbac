...
do
	...
	nsttn ../skde-href-3mb.tcl $simTime 0 Voip POO $lossExp
	...
	nsttn ../skde-href-3mb.tcl $simTime 0 Voip EXPOO $lossExp
	...
	nsttn  ../skde-hhat-3mb.tcl $simTime 0 Voip POO $lossExp
	...
	nsttn  ../skde-hhat-3mb.tcl $simTime 0 Voip EXPOO $lossExp
