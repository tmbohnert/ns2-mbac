...
## G.711 PCM codec for 20ms voip frames
set txRateVoip [expr 64 * pow(10, 3)]
set pLossVoip [expr 1*pow(10, -3)]
# rtp(12)+udp(8)+ip(20) byte + one voip frame/pkt = 200 byte
...
# window length
set wlen 300
$dsQueue addAdcEntry $dscp0 OQA ACCEPT $bnTxRate [expr $bufferSize*$packetSize] $txRate $pLoss TRE $rScore $frLenVoip $packetSize $wlen TRDE FLOWMONE 1400 1510 [expr $simTime-5] END
