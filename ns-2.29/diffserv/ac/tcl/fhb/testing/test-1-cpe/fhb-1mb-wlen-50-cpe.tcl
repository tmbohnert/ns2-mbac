...
set k	3
set lmbd 0.01
#$dsQueue addAdcEntry $dscp0 FHB ACCEPT $bnTxRate [expr $bufferSize*$packetSize] $txRate $pLoss TRE $t TRE $tau $tsm $wlen TRE END
$dsQueue addAdcEntry $dscp0 FHB ACCEPT $bnTxRate [expr $bufferSize*$packetSize] $txRate $pLoss TRE $t TRE $tau $tsm $wlen TRE CPE $k $lmbd END
