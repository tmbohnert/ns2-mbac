...
set tsm 5
set wlen 50
$dsQueue addAdcEntry $dscp0 SKDE ACCEPT $bnTxRate [expr $bufferSize*$packetSize] $txRate $pLoss TRE $hRef $j IEDE TRDE $tau $tsm $wlen TRE
#$dsQueue addAdcEntry $dscp0 SSUM  [expr $bnTxRate] $txRateVideo
$dsQueue printAdcSetup
# enable Emodel
$dsQueue enableEModel $dscp0
